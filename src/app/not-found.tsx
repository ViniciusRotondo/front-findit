...
export default function NotFoundPage() {
    return (
        <div className="flex flex-col min-h-screen bg-white font-lato text-black">
            <Header />
            <main className="flex-grow flex flex-col justify-center items-center px-4 py-24">
                <h1 className="text-6xl font-bold text-[#EE6405] mb-6">404</h1>
                ...
                <div className="bg-[#FFF4ED] border border-[#FFA567] rounded-3xl p-8 max-w-xl w-full shadow-md text-center">
                    ...
                    <Link href="/home" className="text-white bg-[#EE6405] px-6 py-2 rounded-full font-semibold hover:bg-[#FFA567] transition-colors duration-300">
